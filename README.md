...
- O "JWT" gerado usa `alg: "none"` e não possui assinatura.
- Armazenamento de usuários e tokens em `localStorage` é apenas para demonstração.
- Hash de senha é feito no cliente.
